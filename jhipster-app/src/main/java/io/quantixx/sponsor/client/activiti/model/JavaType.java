...
import io.quantixx.sponsor.client.activiti.model.TypeBindings;
...
public class JavaType   {
  ...
  private List<JavaType> interfaces = new ArrayList<JavaType>();
  ...
  **/
  @ApiModelProperty(value = "")
  public Boolean getCollectionLikeType() {
    return collectionLikeType;
  }
  ...
  **/
  @ApiModelProperty(value = "")
  public Boolean getJavaLangObject() {
    return javaLangObject;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(_abstract, arrayType, bindings, collectionLikeType, concrete, containerType, contentType, contentTypeHandler, contentValueHandler, enumType, erasedSignature, _final, genericSignature, _interface, interfaces, javaLangObject, keyType, mapLikeType, primitive, referenceType, referencedType, superClass, throwable, typeHandler, typeName, valueHandler);
  }
