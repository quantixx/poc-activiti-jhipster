...
export class InvoiceService {
    ...
    private resourceUrl = '/sponsor/api/invoices';
    ...
    private convertItemFromServer(json: any): Invoice {
        ...
        entity.limitPaymentDate = this.dateUtils
            .convertLocalDateFromServer(json.limitPaymentDate);
        return entity;
    }
    ...
    private convert(invoice: Invoice): Invoice {
        ...
        copy.limitPaymentDate = this.dateUtils
            .convertLocalDateToServer(invoice.limitPaymentDate);
        return copy;
    }
}
